...
/**
 * Data Access Object or "DAO" lays out the behaviors that a DAO should have 
 * (CRUD methods - create, read, update, delete) to properly interact with the data source.
*/
